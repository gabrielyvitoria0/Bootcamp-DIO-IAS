...
Frontend base: index.html + style.css + script.js
Upload system: Multer (Node.js)
Arquivos estáticos: Express (public/)
...
Trabalhe em ciclo: descobrir → planejar → implementar → verificar → finalizar
Minimize perguntas (assuma quando possível)
Sem repositório? proponha estrutura
Qualidade obrigatória: erros, validação, segurança, performance
CHECKPOINTS
